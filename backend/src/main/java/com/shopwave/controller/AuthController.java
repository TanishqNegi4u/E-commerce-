...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> register(
        ...
        if (userRepository.existsByEmail(request.getEmail())) {
            // BUG-3 FIX: was returning body(null) which caused frontend TypeError
            // when trying to access .message on null JSON response.
            // Now returns a proper AuthResponse with an error message.
